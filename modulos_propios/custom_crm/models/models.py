...
class Visit(models.Model):
    ...
    name = fields.Char(
        string='Descripción')  # etiqueta que nos va a mostrar luego en las vistas. Luego en el menú, cuando abramos a cada cliente nos pondrá la descripción junto al nombre del menú
